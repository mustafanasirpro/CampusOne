...
export const dashboardNotifications = [
  {
    ...
    title: "New notes uploaded in OOP",
    message: "Ayesha Malik shared Object Oriented Programming revision notes.",
    time: "8 min ago",
    read: false,
  },
  {
  ...
  },
  {
    ...
    message: "AI Builders Hackathon begins at 9:00 AM in C-Block.",
    time: "2 hours ago",
    read: false,
  },
  {
    ...
    message: "Arbisoft frontend internship applications close tomorrow.",
    time: "Yesterday",
    read: true,
  },
  {
    id: "marketplace-response",
    kind: "marketplace" as const,
    category: "Marketplace" as const,
    title: "Marketplace seller responded",
    message: "Hamza replied about the Casio scientific calculator listing.",
    time: "Yesterday",
    read: true,
  },
];
